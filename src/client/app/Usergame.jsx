      ...
      <div className='container col-centered text-center'>
       <a href='/'><p>Home</p></a>
        ...
        <div className="col-md-6 col-centered text-center">
                  ...
                  <img className="game_image" src={this.props.info.image !== null ? this.props.info.image.medium_url : "https://az853139.vo.msecnd.net/static/images/not-found.png" }/>
                  <a className='button' href={this.props.info.reviews.site_detail_url}>Click here for reviews</a>
          ...
          return(
            <div>
            <h4> pictures</h4>
              <img className="game_image" src={image !== null ? image.small_url : "https://az853139.vo.msecnd.net/static/images/not-found.png" }/>
            </div>
          )
            })
            )
